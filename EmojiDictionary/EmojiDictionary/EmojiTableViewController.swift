...
class EmojiTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView : UITableView, moveRowAt moveRowAtfromIndexPath : IndexPath , to: IndexPath){
        let movedemoji = emojis.remove(at: moveRowAtfromIndexPath.row)
